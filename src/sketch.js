...
//translate (windowWidth/2, windowHeight/2)
	...
	if (detector && capture.loadedmetadata) {
		...
		if (hands.length == 1) {
			...
			// 	image(img1, width/2-371/2/2, height/2- 586/2/2, 371/2, 586/2)
			// }
			else if (pollicecentro>50 && indicepalmo>50 && mediopalmo<100 && anularepalmo<100 && mignolopalmo<100){
				background(255)
			...
			else if (pollicecentro>50 && indicepalmo>50 && mediopalmo>50 && anularepalmo<100 && mignolopalmo<100){
				background(255)
				image(img3, width/2-371/2/2, height/2- 586/2/2, 371/2, 586/2)
			}
			else if (pollicecentro>50 && indicepalmo>50 && mediopalmo>50 && anularepalmo>50 && mignolopalmo<100){
				background(255)
